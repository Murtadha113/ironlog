...
SEED_MACHINES.push(
  ...
  // ===== الذراعين — إضافات =====
  quick('cable_bicep_curl', 'Cable Bicep Curl', 'كيرل بايسبس بالكيبل', 'arms', IMG.cable),
  quick('overhead_tricep_ext', 'Overhead Tricep Extension', 'مد الترايسبس العلوي', 'arms', IMG.cable),
  quick('tricep_dip_machine', 'Tricep Dip Machine', 'جهاز الدبس للترايسبس', 'arms', IMG.dipStation),
  quick('wrist_curl_machine', 'Forearm / Wrist Curl Machine', 'جهاز الساعد', 'arms', IMG.grip),
  quick('reverse_curl_machine', 'Reverse Curl Machine', 'كيرل معكوس', 'arms', IMG.dbBench, 'free_weight'),
  quick('spider_curl_bench', 'Spider Curl Bench', 'بنش سبايدر كيرل', 'arms', IMG.bench, 'free_weight'),
  quick('concentration_curl_bench', 'Concentration Curl Bench', 'بنش كونسنتريشن كيرل', 'arms', IMG.bench, 'free_weight'),
  ...
  quick('wrist_roller', 'Wrist Roller', 'لفافة المعصم', 'neck', IMG.grip),
  quick('grip_strength_trainer', 'Grip Strength Trainer', 'جهاز قوة القبضة', 'neck', IMG.grip),
  quick('stretching_machine', 'Stretching Machine', 'جهاز الإطالة', 'neck', IMG.neck),

  // ===== أوزان حرة — إضافات =====
  quick('dumbbells_rack_set', 'Dumbbells (Rack)', 'دمبل، طقم كامل', 'arms', IMG.dumbbellRack, 'free_weight'),
  quick('adjustable_dumbbells', 'Adjustable Dumbbells', 'دمبل قابل للتعديل', 'arms', IMG.dumbbellRack, 'free_weight'),
  quick('olympic_barbell', 'Olympic Barbell', 'بار أولمبي', 'back', IMG.barbell, 'free_weight'),
  quick('ez_curl_bar', 'EZ Curl Bar', 'بار إي زد', 'arms', IMG.barbell, 'free_weight'),
  quick('straight_curl_bar', 'Straight Curl Bar', 'بار مستقيم', 'arms', IMG.barbell, 'free_weight'),
  ...
  quick('preacher_curl_bench', 'Preacher Curl Bench', 'بنش بريتشر كيرل', 'arms', IMG.bench, 'free_weight'),
